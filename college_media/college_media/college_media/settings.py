"""
Django settings for college_media project.
...
SECRET_KEY = 'django-insecure-4dij^jsxy(@seg_7u_o$261jgg4*4y1+t5!anchnk2^5s+vsl$'
...
ROOT_URLCONF = 'college_media.urls'
    ...
    { 
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'staff_app.context_processors.student_profile',
            ],
        },
    },
]
...
# configaration for mail sending 
# settings.py

EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'  # Use Gmail's SMTP server or any other service
EMAIL_PORT = 587
